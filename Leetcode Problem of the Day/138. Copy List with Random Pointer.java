...
class Solution {
    public Node copyRandomList(Node head) {
        ...
        // First: make copy of each node
        // and place them side byt side.
        while(iter!=null){
            next = iter.next;
        ...
        iter = head;
        // Second: assign random pointer for copied nodes
        while(iter!=null){
            if(iter.random != null)
        ...
        // Third: extract original Node list
        // and separate copied list Node.
