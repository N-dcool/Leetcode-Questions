...
class Solution {
    public List<List<Integer>> findWinners(int[][] matches) {
        ...
        for(int[] match : matches){
            ...
            won.put(match[0], won.getOrDefault(match[0],0)+1);
        }
        ...
        for(Map.Entry<Integer,Integer> entry : won.entrySet()){
            ...
            if(!lost.containsKey(team))
                wonList.add(team);
        }
        
        Collections.sort(wonList);
        result.add(new ArrayList(wonList));
        ...
        result.add(new ArrayList(lostList));
